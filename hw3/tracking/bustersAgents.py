...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for counter in livingGhostPositionDistributions:
            ...
            if self.distancer.getDistance(counter.argMax(), pacmanPosition) < minDist:
                minDist = self.distancer.getDistance(counter.argMax(), pacmanPosition)
                closestSquare = counter.argMax()
        ...
        for action in legal:
            ...
            if self.distancer.getDistance(closestSquare, Actions.getSuccessor(pacmanPosition, action)) < minDist:
                minDist = self.distancer.getDistance(closestSquare, Actions.getSuccessor(pacmanPosition, action))
                bestAction = action
