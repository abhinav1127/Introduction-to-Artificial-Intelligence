...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        pacmanPosition = gameState.getPacmanPosition() #a
        ...
        if noisyDistance == None:
            ...
            for p in self.legalPositions:
                trueDistance = util.manhattanDistance(p, pacmanPosition)  # b

                prob = emissionModel[trueDistance] * self.beliefs[p]
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for pos in self.legalPositions:
            ...
            prevBelief = self.beliefs[pos]

            for key in newPosDist.keys():
                allPossible[key] += prevBelief * newPosDist[key]
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        while particles > 0:
            ...
            if legalCounter == len(positions):
                legalCounter = 0

            placedParticles.append(positions[legalCounter])
            particles -= 1
            legalCounter += 1

        self.particleArray = placedParticles
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance == None:
            counter[self.getJailPosition()] = 1

        else:

            for position in self.particleArray:

                distance = util.manhattanDistance(position, pacmanPosition)

                counter[position] += emissionModel[distance]
        ...
        if counter.totalCount() == 0:
            ...
            for i in range(self.numParticles):
                particleArray.append(util.sample(counter))
    ...
    def elapseTime(self, gameState):
        ...
        for position in self.particleArray:
            ...
            newBeliefs.append(util.sample(newPosDist))

        self.particleArray = newBeliefs
